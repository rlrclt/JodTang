/**
 * สถานะกำลังโหลดของ /settings/categories — skeleton 5 แถวโครงเท่าของจริง (spec §5)
 * ห้ามใช้ spinner กลางจอ (design §2) · แอนิเมชันถูกปิดเองเมื่อ prefers-reduced-motion (globals.css)
 */
