...
/**
 * ข้อความยืนยันตอนลบ — ต้องบอกความจริงทั้งสองด้าน: หายจากยอดทันที และ **กู้คืนได้ที่ไหน**
 * (wave21: มีหน้าถังขยะแล้ว ข้อความเดิม "กู้คืนจากในแอปไม่ได้" กลายเป็นเท็จ)
 */
const DELETE_IMPACT = 'ลบแล้วรายการหายจากยอดและรายงานทันที · กู้คืนได้ที่ ตั้งค่า › รายการที่ลบแล้ว';
